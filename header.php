        ...
        <?php
            ...
            if($isLoggedIn && $is_admin==0)
            {
                ...
                ?>
                    ...
                    <a href="/merajobs/inbox.php" class="nav-item nav-link"><i class="fa fa-briefcase"></i> Skills Inbox</a>
                    ...
                    <a class="nav-item nav-link" onclick="logout(<?=$isLoggedIn?>)"><i class="fa fa-sign-out-alt"></i> Logout</a>

                <?php
            } else if($isLoggedIn && $is_admin==1) {
                $username=$_SESSION['user_name'];
                ?>
